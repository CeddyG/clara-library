...
<div class="col-md-6">
    ...
    <div class="box box-info">
        ...
        <div class="box-footer clearfix">
            {!! Button::info('Ajouter')->asLinkTo(route('admin.library.create'))->small() !!}
        </div>
        <!-- /.box-footer -->
    </div>
    <!-- /.box -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tab-admin').DataTable({
                serverSide: true,
                ajax: {
                    'url': '{{ route('admin.library.index.ajax') }}'
                },
                columns: [
                    { 'data': 'id_library' },
                    { 'data': 'title_library' },
					{ 'data': 'url_library' },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = "{!! Button::warning('Modifier')->asLinkTo(route('admin.library.edit', 'dummyId'))->extraSmall()->block()->render() !!}";
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = '{!! BootForm::open()->action( route("admin.library.destroy", "dummyId") )->attribute("onsubmit", "return confirm(\'Vraiment supprimer cet objet ?\')")->delete() !!}'
